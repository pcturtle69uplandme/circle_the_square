...
if Qwen3TTSModel:
    ...
    instruct_christina = "A 38-year-old female corporate strategist with a feminine alto voice. Speaks in a crisp, clear, unhurried British London Received Pronunciation female accent. Cold, deadpan, calm female speaker."
    
    print(f"Synthesizing Christina Dross Female VoiceDesign line: '{text_christina}'...")
    ...
    print(f"Saved Christina Dross Female Qwen3-TTS GPU Audio: {out_christina} ({os.path.getsize(out_christina)} bytes)")
