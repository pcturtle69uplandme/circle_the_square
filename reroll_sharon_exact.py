...
if Qwen3TTSModel:
    ...
    text_sharon = "Well I have needs too Jan that must be met."
    instruct_sharon = "gender: Female.\nage: 34 years old adult female.\npitch: Warm, confident adult female alto voice.\nspeed: Unhurried, transactional, blunt pacing.\nemotion: Level, unbothered, confident female speaker.\npersonality: Plain-spoken opportunist.\naccent: Welsh adult female accent with a subtle natural lilt."
    
    print(f"Synthesizing Sharon 34-Yr-Old Female VoiceDesign line: '{text_sharon}'...")
    ...
    print(f"Saved Sharon 34-Yr-Old Qwen3-TTS GPU Audio: {out_sharon} ({os.path.getsize(out_sharon)} bytes)")
